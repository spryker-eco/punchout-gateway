<?php  //[STAMP] 9287e93a671cf1b3efa457a8aa7f08ee
// phpcs:ignoreFile
...
trait PunchoutGatewayCommunicationTesterActions
{
    /**
     ...
     *
     *
     * @see \SprykerTest\Zed\Store\Helper\StoreDependencyHelper::addCurrentStore()
     */
    public function addCurrentStore(\Generated\Shared\Transfer\StoreTransfer $storeTransfer): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('addCurrentStore', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerTest\Zed\Store\Helper\StoreDependencyHelper::removeCurrentStore()
     */
    public function removeCurrentStore(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('removeCurrentStore', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerTest\Shared\Customer\Helper\CustomerDataHelper::haveConfirmedCustomer()
     */
    public function haveConfirmedCustomer(array $override = []): \Generated\Shared\Transfer\CustomerTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveConfirmedCustomer', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerTest\Shared\Customer\Helper\CustomerDataHelper::haveConfirmedCustomerWithAddress()
     */
    public function haveConfirmedCustomerWithAddress(array $override = []): \Generated\Shared\Transfer\CustomerTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveConfirmedCustomerWithAddress', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerTest\Shared\Customer\Helper\CustomerDataHelper::confirmCustomerByEmail()
     */
    public function confirmCustomerByEmail(string $email): \Generated\Shared\Transfer\CustomerTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('confirmCustomerByEmail', func_get_args()));
    }
     ...
     * @see \SprykerTest\Shared\Customer\Helper\CustomerDataHelper::haveCustomerAddress()
     */
    public function haveCustomerAddress(array $seed = []): \Generated\Shared\Transfer\AddressTransfer {
     ...
     *
     *
     * @see \SprykerTest\Shared\Customer\Helper\CustomerDataHelper::getCustomerFacade()
     */
    public function getCustomerFacade(): \Spryker\Zed\Customer\Business\CustomerFacadeInterface {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCustomerFacade', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerEcoTest\Shared\PunchoutGateway\Helper\PunchoutGatewayDataHelper::havePunchoutConnection()
     */
    public function havePunchoutConnection(array $seed = []): \Generated\Shared\Transfer\PunchoutConnectionTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('havePunchoutConnection', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerEcoTest\Shared\PunchoutGateway\Helper\PunchoutGatewayDataHelper::findPunchoutSessionBySessionToken()
     */
    public function findPunchoutSessionBySessionToken(string $sessionToken): ?\Generated\Shared\Transfer\PunchoutSessionTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('findPunchoutSessionBySessionToken', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerEcoTest\Shared\PunchoutGateway\Helper\PunchoutGatewayDataHelper::countPunchoutSessionsByBuyerCookie()
     */
    public function countPunchoutSessionsByBuyerCookie(string $buyerCookie): int {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('countPunchoutSessionsByBuyerCookie', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerEcoTest\Shared\PunchoutGateway\Helper\PunchoutGatewayDataHelper::havePunchoutCredential()
     */
    public function havePunchoutCredential(array $seed = []): \Generated\Shared\Transfer\PunchoutCredentialTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('havePunchoutCredential', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerEcoTest\Shared\PunchoutGateway\Helper\PunchoutGatewayDataHelper::findPunchoutSessionByIdQuote()
     */
    public function findPunchoutSessionByIdQuote(int $idQuote): ?\Generated\Shared\Transfer\PunchoutSessionTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('findPunchoutSessionByIdQuote', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerEcoTest\Shared\PunchoutGateway\Helper\PunchoutGatewayDataHelper::havePunchoutSession()
     */
     ...
     */
    public function havePersistentQuote(array $seed = [], ?bool $shouldReloadItems = false): \Generated\Shared\Transfer\QuoteTransfer {
