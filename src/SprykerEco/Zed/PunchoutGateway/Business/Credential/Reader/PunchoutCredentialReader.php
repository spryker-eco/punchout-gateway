...
class PunchoutCredentialReader implements PunchoutCredentialReaderInterface
{
    ...
    {
        return $this->repository->getPunchoutCredentialCollection($criteriaTransfer);
    }

    public function findPunchoutCredentialById(int $idPunchoutCredential): ?PunchoutCredentialTransfer
    {
        return $this->repository->findPunchoutCredentialById($idPunchoutCredential);
    }
}
